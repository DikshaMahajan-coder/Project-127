...
#Webdriver
browser = webdriver.Edge("E:/Drive 1/Study/WhiteHatJr/Projects/Project 127/msedgedriver.exe")
browser.get(START_URL)

scarped_data = []

#Define Data Dcrapping Method
def scrape():
...
stars_df_1.to_csv("scarped_data.csv", index = True, index_label = 'id')
